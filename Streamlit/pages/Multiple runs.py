...
st.set_page_config(
    page_title="MKM Input File Generator and Solver for Multiple runs",
    page_icon=":coffee:",
)

st.title("e-MKM Input File Generator and Solver for Multiple runs")
st.page_icon = ":coffee:"

def main():
    os.chdir("D:/projects/mkm_shell/e-MKM")  # Adjust as per your directory
...
if __name__ == "__main__":
    main()
>>>>>>> 2e7861be448d4944733e23d44bd09ca25f692f7b
